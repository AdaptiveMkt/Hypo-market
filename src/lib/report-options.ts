...
export const DETAIL_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "lifeFace", label: "Life insurance face amount" },
      { id: "adbDefs", label: "Accelerated death benefits, viaticals, and life settlements" },
...
export const DETAIL_HINTS: Record<DetailId, string> = {
  ...
  lifeFace: "Face amount is shown only. It does not pay care unless an accelerated death benefit for terminal illness applies, or the policy is sold to a third party.",
  adbDefs: "Definitions of accelerated death benefits, viatical settlements, and life settlements. Educational only. None of these pay care in this model unless the cash is entered as a countable asset.",
